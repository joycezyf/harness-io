    ...
    <>
      ...
      <>
        <main className={css.main}>
          <div className={css.harnessIntroCloudCost}>
            <div className={css.introTextContainer}>
              <div className={css.introText}>Cloud Cost Management</div>
              <div
              ...
              <div className={css.introDesc}>
                Self-Service Continuous Delivery that enables engineers to
                deploy on-demand without a single script.
              </div>
            ...
            <div className={css.introIllustration}>
              <img
                src="/product-cloud-cost-video-placeholder.svg"
                width="650"
                height="374"
                // muted={true}
                // autoPlay={true}
            ...
            <div className={cx(css.caseStudy, css.bgDot)}>
              <div className={css.sectionWrapper}>
                ...
                <LazyLoadImage
                  ...
                  src="/case-study-profile-cloud-cost-1.svg"
              ...
              <table cellSpacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      Organizations Shared Resources &amp; Template Library
                      Custom Dashboards Data export &amp; reporting Log
                      forwarding into Splunk Delegate Scoping
                    </td>
                  </tr>
                  <tr>
                    <td>Security</td>
            ...
            <div className={cx(css.caseStudy, css.bgDotBlue)}>
              <div className={css.sectionWrapper}>
                ...
                <LazyLoadImage
                  ...
                  src="/case-study-profile-cloud-cost-2.svg"
                  placeholderSrc="/favicon.png"
...
export default ProductCloudCost
