    ...
    <>
      ...
      <>
        <main className={css.main}>
          <div className={css.harnessIntroChIntel}>
            <div className={css.introTextContainer}>
              <div className={css.introText}>Change Intelligence</div>
              <div
            ...
            <div className={css.introIllustration}>
              <img
                src="/product-ch-intel-video-placeholder.svg"
                width="650"
                height="374"
                // muted={true}
                // autoPlay={true}
            ...
            <div className={cx(css.caseStudy, css.bgDot)}>
              <div className={css.sectionWrapper}>
                ...
                <LazyLoadImage
                  ...
                  src="/case-study-profile-ch-intel-1.svg"
            ...
            <div className={cx(css.caseStudy, css.bgDotBlue)}>
              <div className={css.sectionWrapper}>
                ...
                <LazyLoadImage
                  ...
                  src="/case-study-profile-ch-intel-2.svg"
                  placeholderSrc="/favicon.png"
