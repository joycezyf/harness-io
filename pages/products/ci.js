...
import css from './ci.module.scss'
        ...
        <div className={css.harnessIntro}>
          <div className={css.introTextContainer}>
            ...
            <div className={css.introDesc}>
              Harness CI (formerly Drone) is a self-service CI solution that is
              container-native so all builds are isolated, and all extensions
              are standardized. Kiss your butler goodbye.
            </div>
